INSERT INTO user(id,login,password,roles,user_elo) VALUES (1, 'a', '$2a$04$w9hNQY4WhDNcDVeZ5rVdpO6vhdGuOuU/Fs2B0QOopNRrzuH7wR9XO', 'USER', 1200);
...
INSERT INTO clan VALUES (1,'Muchas salchichas',1200,'Salchicha','Salchigame');
INSERT INTO clan VALUES (2,'aouhdufodg',1200,'DSndfds','Counter Strike');
INSERT INTO clan VALUES (3,'Este es el tercer clan',1200,'Tercer','Starcraft II');
INSERT INTO clan VALUES (4,'Ya van 4, mae mia',1200,'444','Tetris');
...
SELECT * FROM clan ORDER BY clanElo DESC;
